...
public class BlancuhThroneRoomGraphicsContext extends ScriptGraphicsContext {

    private BlancuhThroneRoom script;

    public BlancuhThroneRoomGraphicsContext(ScriptConsole scriptConsole, BlancuhThroneRoom script) {
        super(scriptConsole);
        this.script = script;
    }
